			...
			<ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
				...
				<!--<li class="start active ">
					...
					<ul class="sub-menu">
						...
						<li>
							<a href="{{URL::to('/admin/dashboard/transactionhistory')}}">
				...
				<li {!! Request::is('admin/customer/*') ? 'class="start active"' : 'class=""'  !!}>
				...
				<li {!! Request::is('admin/settings/*') ? 'class="start active"' : 'class=""'  !!}>
...
setTimeout(
    ...
    200  //1,000 milliseconds = 1 second
);
</script>
</body>
<!-- END BODY -->
