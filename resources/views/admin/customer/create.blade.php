...
@section('content')
	...
	<div class="portlet box green">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-reorder"></i>New Customer Details
			</div>
			
		</div>
		<div class="portlet-body form">
			<!-- BEGIN FORM-->
{!! Form::open(array('url' => URL::to('/admin/customer/create'),'class' => 'form-horizontal customer_details' )) !!}
				<div class="form-body">
...
{!!Form::text('email',Input::old('email'),array('class'=>'form-control','placeholder' => 'Enter Email','autocomplete' => 'off')) !!}								
