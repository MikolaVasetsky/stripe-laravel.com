...
class ComposerAutoloaderInitc0fe1f6f8fbfba0b3eb4dff781ba43af
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            ...
            call_user_func(\Composer\Autoload\ComposerStaticInitc0fe1f6f8fbfba0b3eb4dff781ba43af::getInitializer($loader));
        } else {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitc0fe1f6f8fbfba0b3eb4dff781ba43af::$files;
        } else {
